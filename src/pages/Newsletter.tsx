...
const NewsletterForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post(
        `https://granth-backend.onrender.com/send-newsletter`,
        payload
      );
        ...
        >
          ...
          <div className="text-center">
            <button
              type="submit"
              disabled={loading}
              className={`w-fit flex justify-center items-center bg-gradient-to-r from-[var(--primary-color)] via-[#e3c5b5] to-[var(--primary-color)] text-black font-medium py-2 px-6 hover:opacity-80 ${
